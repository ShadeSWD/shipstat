 ...
 * экспериментальные точки, вся штатная обработка работает и от отчётных, и от снятых данных. */
'use strict';
(function () {
  const G = 9.81;
  ...
  function v1Reset() {
    ...
    $('vx1-msg').textContent = 'Возвращены данные отчёта лабораторной (19 размахов, T_n = 10,7 с, n = 9).';
    lab1();
  }
  ...
  function v2Reset() {
    ...
    $('vx2-msg').textContent = 'Возвращены 8 режимов из отчёта лабораторной.';
    lab2();
